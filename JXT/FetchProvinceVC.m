...
#import "FetchProvinceVC.h"

@interface FetchProvinceVC ()

@end

@implementation FetchProvinceVC
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //天才级代码
    NSString* fetchVCID=@"FetchCityVCID";
    NSArray* specialCity=@[@"北京",@"天津",@"重庆",@"上海",];
    if([specialCity containsObject:[tmpDict objectForKey:@"areaName"]])
        fetchVCID=@"FetchTownVCID";
    
   FetchAreaBaseTableVC* fetchVC= [self.storyboard instantiateViewControllerWithIdentifier:fetchVCID];
