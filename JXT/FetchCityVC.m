...
#import "FetchCityVC.h"

@interface FetchCityVC ()

@end

@implementation FetchCityVC
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    FetchAreaBaseTableVC* fetchVC= [self.storyboard instantiateViewControllerWithIdentifier:@"FetchTownVCID"];
